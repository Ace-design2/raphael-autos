    ...
    <div className="flex flex-col min-h-screen bg-[#050505] text-white selection:bg-cooliocns-gold selection:text-[#050505]">
      <main className="flex-1 flex flex-col">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-16 md:py-32 overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row gap-12 md:gap-20 mb-20 md:mb-32">
                <div className="md:w-5/12 flex flex-col justify-start">
                  <h2 className="font-display text-4xl sm:text-5xl md:text-6xl text-[#111111] font-light tracking-tight leading-[1.1] mb-6">
                ...
                <div className="md:w-7/12 flex flex-col gap-6 font-body text-gray-600 text-sm sm:text-base leading-relaxed tracking-wide">
                  <p>
              ...
              <div className="w-full">
                <div className="flex items-center gap-4 mb-8 md:mb-12">
                  <h3 className="font-body text-xs sm:text-sm text-[#111111] uppercase tracking-[0.2em] font-bold shrink-0">Technical Specifications</h3>
                ...
                <div className="flex flex-col md:flex-row gap-x-20 gap-y-12">
                  ...
                  <div className="flex-1 flex flex-col gap-4">
                    {[
                      ...
                      <div key={i} className="flex flex-wrap sm:flex-nowrap justify-between items-baseline gap-2 border-b border-black/10 pb-3">
                        <span className="font-body text-[10px] sm:text-xs text-gray-500 uppercase tracking-widest shrink-0">{spec.label}</span>
                        <span className="font-body text-sm sm:text-base text-[#111111] text-right break-words">{spec.value}</span>
                      </div>
                    ))}
                  </div>
        ...
        <FeaturedInventory 
          ...
          subtitle="Similar Vehicles" 
          description="Explore other hand-selected vehicles in our collection that share a similar pedigree." 
        />
